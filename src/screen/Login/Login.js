...
const LogIn = ({navigation}) => {
    ...
    return (
        <>
            ...
            <Text style={tw`text-4xl left-0 font-bold text-black mt-15 mx-5`}>Login your {'\n'}Account</Text>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('Interest')}>
                <View style={tw`bg-[#FF4D67] mx-5 rounded-full h-12`}>
                    <Text style={tw`text-white mx-auto my-auto`}>Sign in</Text>
                </View>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('ForgetPswdHero')}>
                <View>
                    <Text style={tw`text-[#FF4D67] text-center my-5`}>Forget the password?</Text>
                </View>
            </TouchableOpacity>
            ...
            <View style={tw`mx-auto py-3 flex-row`}>
                <Text style={[style.button,tw``]}>Already have an account? </Text>
                <TouchableOpacity>
                    <View>
                        <Text style={[style.button,tw`text-[#FF4D67]`]}  onPress={()=>navigation.navigate('Signup')}>Sign up</Text>
                    </View>
                </TouchableOpacity>
            </View>
        </>
